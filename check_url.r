#This script was copied from 'https://github.com/briatte/awesome-network-analysis'
#All the credit belongs to François Briatte
#
#
# Common errors
# -------------
...
if (!file.exists(f)) {
  ...
  u <- str_c(
    ...
    "luismmontilla/awesome-coral-research/",
    "master/README.md"
  )
